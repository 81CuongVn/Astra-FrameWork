...
parser.add_argument('-f', dest='ip_list', type=str, default='./Loot/rpihunter/rpi_list',
		help='ip list to use (default ./Loot/rpihunter/rpi_list)')
...
parser.add_argument('-dp', dest='quiet', action='store_true',
...
def scan():
	if not args.no_scan and not args.safe:
		os.system('sudo arp-scan -g '+args.ip_range+' -W ./Loot/rpihunter/scan.pcap'+quiet)
		os.system('tshark -r ./Loot/rpihunter/scan.pcap > ./Loot/rpihunter/pcap.txt 2>/dev/null')
		os.system('cat ./Loot/rpihunter/pcap.txt | grep -i "rasp" > ./Loot/rpihunter/raspi_list')
		os.system('awk \'{print $8}\' ./Loot/rpihunter/raspi_list > ./Loot/rpihunter/rpi_list')
		os.system('rm -rf ./Loot/rpihunter/scan.pcap && rm -rf ./Loot/rpihunter/pcap.txt && rm -rf ./Loot/rpihunter/raspi_list')
		cprint('\nlocated '+ str(sum(1 for line in open ('./Loot/rpihunter/rpi_list'))) + ' raspi\'s', 'yellow')
